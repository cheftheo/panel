...
<head>
    ...
    <title>Panel <?php echo $serverName ?> - Tickets</title>
...
$(document).ready(function() {
	$("#results" ).load( "paginatie_tickets.php");
	$("#results").on( "click", ".pagination a", function (e){
		e.preventDefault();
		$(".loading-div").show();
		var page = $(this).attr("data-page");
		$("#results").load("paginatie_tickets.php",{"page":page}, function(){
			$(".loading-div").hide();
		});
...
<div class="container-fluid">
    <a href="<?=$serverURL;?>tickets-create.php" class="btn btn-danger m-b-20 p-10 btn-block waves-effect waves-light">Ticket Create</a>
    <br>
    <br>
    <div class="row">
        <div class="col-12">
                    ...
                    <div class="row m-t-40">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-inverse" style="background-color: #4CAF50 !important">
                                <div class="box text-center">
                                    <h1 class="font-light text-white"><?=$ticketsactive[0];?></h1>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-inverse card-danger">
                                <div class="box text-center">
                                    <h1 class="font-light text-white"><?=$ticketerezolvate[0];?></h1>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card card-inverse card-info card-warning">
                                <div class="box text-center">
                                    <h1 class="font-light text-white"><?=$totaltickets[0];?></h1>
