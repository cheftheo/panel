...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row"><a class="btn btn-success" style="float:right;" href="<?=$serverURL;?>unban-create.php">Create</a></div>
            <div class="row m-t-sm">
                <table class="table table-bordered table-hover table-bordered">
                    ...
                    <tbody>
					<?php
					$sql = "SELECT * FROM `unban-panel` WHERE Username='".$_SESSION['Username']."' ORDER BY ID DESC";
					$result = $db->query($sql);
					...
					if ($result->num_rows > 0) {
						...
						?>
							<tr>
								...
								<td><a href="<?=$serverURL;?>unban-view.php?id=<?=$row["ID"];?>">View</a> </td>
							</tr>
						<?php
						}
					}
