...
<head>
    ...
    <title>Panel <?php echo $serverName ?> - Businesses</title>
...
$(document).ready(function() {
	$("#results" ).load( "paginatie_businesses.php");
	$("#results").on( "click", ".pagination a", function (e){
		e.preventDefault();
		$(".loading-div").show();
		var page = $(this).attr("data-page");
		$("#results").load("paginatie_businesses.php",{"page":page}, function(){
			$(".loading-div").hide();
		});
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Businesses</h3>
                </div>
...
<script>
		function showMap(x,y) {
			...
			var src = "location.php?x="+x+"&y="+y+"",
            img = document.createElement('img');
			img.src = src;
			
			swal(
				'View map',
				'<img src = "'+img.src+'" height = "400px"></img>',
				'' 
			)
		}
</script>